...
var stringToModelType = map[Type]models.TokenType{
	...
	// Operators
	Type("+"): models.TokenTypePlus,
	Type("-"): models.TokenTypeMinus,
	Type("/"): models.TokenTypeDiv,
	Type("~"): models.TokenTypeTilde,
	Type("~*"): models.TokenTypeTildeAsterisk,
	Type("!~"): models.TokenTypeExclamationMarkTilde,
	Type("!~*"): models.TokenTypeExclamationMarkTildeAsterisk,
	Type("STRING_CONCAT"): models.TokenTypeStringConcat,
	Type("PLUS"):  models.TokenTypePlus,
	Type("MINUS"): models.TokenTypeMinus,

	// Keywords missing from original map
	Type("BETWEEN"):    models.TokenTypeBetween,
	Type("CASE"):       models.TokenTypeCase,
	Type("CAST"):       models.TokenTypeCast,
	Type("COUNT"):      models.TokenTypeCount,
	Type("CREATE"):     models.TokenTypeCreate,
	Type("CROSS"):      models.TokenTypeCross,
	Type("CUBE"):       models.TokenTypeCube,
	Type("CURRENT"):    models.TokenTypeCurrent,
	Type("DESC"):       models.TokenTypeDesc,
	Type("DISTINCT"):   models.TokenTypeDistinct,
	Type("ELSE"):       models.TokenTypeElse,
	Type("END"):        models.TokenTypeEnd,
	Type("EXCEPT"):     models.TokenTypeExcept,
	Type("FIRST"):      models.TokenTypeFirst,
	Type("FOLLOWING"):  models.TokenTypeFollowing,
	Type("FULL"):       models.TokenTypeFull,
	Type("INDEX"):      models.TokenTypeIndex,
	Type("INNER"):      models.TokenTypeInner,
	Type("INTERSECT"):  models.TokenTypeIntersect,
	Type("INTERVAL"):   models.TokenTypeInterval,
	Type("IS"):         models.TokenTypeIs,
	Type("JOIN"):       models.TokenTypeJoin,
	Type("LEFT"):       models.TokenTypeLeft,
	Type("LIKE"):       models.TokenTypeLike,
	Type("NEXT"):       models.TokenTypeNext,
	Type("OUTER"):      models.TokenTypeOuter,
	Type("OVER"):       models.TokenTypeOver,
	Type("PARTITION"):  models.TokenTypePartition,
	Type("PLACEHOLDER"): models.TokenTypePlaceholder,
	Type("PRECEDING"):  models.TokenTypePreceding,
	Type("RANGE"):      models.TokenTypeRange,
	Type("RECURSIVE"):  models.TokenTypeRecursive,
	Type("RIGHT"):      models.TokenTypeRight,
	Type("ROLLUP"):     models.TokenTypeRollup,
	Type("ROW"):        models.TokenTypeRow,
	Type("ROWS"):       models.TokenTypeRows,
	Type("THEN"):       models.TokenTypeThen,
	Type("UNBOUNDED"):  models.TokenTypeUnbounded,
	Type("UNION"):      models.TokenTypeUnion,
	Type("VIEW"):       models.TokenTypeView,
	Type("WHEN"):       models.TokenTypeWhen,

	// DDL/DML extras
	Type("POLICY"):     models.TokenTypeKeyword,
	Type("CONNECTOR"):  models.TokenTypeKeyword,
	Type("NOSUPERUSER"):  models.TokenTypeNoSuperuser,
	Type("NOCREATEDB"):   models.TokenTypeNoCreateDB,
	Type("NOCREATEROLE"): models.TokenTypeNoCreateRole,
	Type("NOLOGIN"):      models.TokenTypeNoLogin,
}
