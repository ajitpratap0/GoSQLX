...
SELECT AVG(ss_quantity) AS avg_qty, AVG(ss_ext_sales_price) AS avg_sales,
    AVG(ss_ext_wholesale_cost) AS avg_wholesale, SUM(ss_ext_wholesale_cost) AS sum_wholesale
FROM store_sales
...
WHERE
    ...
    AND ca_state IN ('TX', 'OH', 'OR', 'NM', 'KY', 'VA', 'MS');
